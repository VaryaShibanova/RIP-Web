...
('http://127.0.0.1:9000/images/img/card1.jpg', 'Извержение вулкана Уайнапутина', 'На срезе дерева, жившего в 1600 году, хорошо заметно одно очень узкое и темное годовое кольцо. Оно резко контрастирует с более широкими светлыми кольцами до и после него. Это кольцо 1601 года.', 1600, '3,5', false),
('http://127.0.0.1:9000/images/img/card2.jpg', 'Извержение Тамбора', 'На срезе дерева хорошо видно три аномальных кольца старше. Такие кольца 1815 года характеризуются узкими, фрагментированными темными кольцами 1816 года и относительно широкими кольцами 1817 года.', 1815, '10-15', false),
...
('http://127.0.0.1:9000/images/img/card7.jpg', 'Великий пожар годов Мэйрэки', 'На срезе вида аномалия на 15-м кольце от коры. Само кольцо 1657 года неровное и фрагментированное: с одной стороны узкое и плотное, с другой — более широкое. За ним следует аномально широкое светлое кольцо 1658 года.', 1657, '8,9,10', false);

-- Сначала создаем пользователей
INSERT INTO users (id, login, password, is_moderator) VALUES
(1, 'user1', 'password1', false),
(2, 'researcher1', 'pass123', false),
(3, 'moderator1', 'modpass', true);

-- Затем вставляем деревья с существующими creator_id
INSERT INTO trees (id, status, description, total_rings, final_year, date_create, date_update, creator_id) VALUES
(1, 'черновик', 'Исследование вулканических событий по древесным кольцам', 235, 1600, '2024-01-15 10:30:00', '2024-01-15 10:30:00', 1),
(2, 'сформирован', 'Анализ климатических изменений в XVII веке', 180, 1657, '2024-01-10 14:20:00', '2024-01-12 16:45:00', 1),
(3, 'завершён', 'Комплексное исследование аномалий XIX века', 220, 1883, '2024-01-05 09:15:00', '2024-01-08 11:30:00', 1),
(4, 'отклонён', 'Исследование наводнений XX века', 150, 1931, '2024-01-03 13:40:00', '2024-01-04 15:20:00', 1),
(5, 'удалён', 'Предварительное исследование', 100, 1962, '2023-12-20 08:50:00', '2023-12-21 10:30:00', 1);

-- Вставка элементов деревьев (убедитесь, что anomaly_id существуют в таблице anomalies)
